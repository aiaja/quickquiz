    ...
    <div className="bg-base-100 border-b border-base-300 sticky top-0 z-50">
      <div className="container mx-auto px-4 py-3 flex items-center justify-between">
        ...
        <div className="flex items-center gap-6">
          <div
            className={`flex items-center gap-3 px-6 py-2 rounded-2xl shadow-inner border transition-colors ${timeRemaining <= 10 ? "bg-error/10 border-error/20 text-error" : "bg-base-200 border-base-300 text-primary"}`}
          >
            <TimerIcon
              className={`w-5 h-5 ${timeRemaining <= 10 ? "animate-bounce" : "animate-pulse"}`}
            />
          ...
          <div className="flex items-center gap-3 bg-success/10 px-6 py-2 rounded-2xl border border-success/20">
